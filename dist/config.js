...
dotenv.config();
const { API_ID, API_HASH, SESSION, OPENAI_API_KEY, ORGANIZATION_ID, LANGUAGE, BOT_ID, } = process.env;
...
export { BOT_ID, API_ID, API_HASH, SESSION, OPENAI_API_KEY, ORGANIZATION_ID, recapTextRequest, openai, LANGUAGE, toxicRecapRequest, };
