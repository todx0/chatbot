...
export const RANDOM_REPLY_PERCENT = 0.6;

const genAImodelName = 'models/gemini-2.0-flash-lite';
...
You are an AI assistant to entertain and annoy chat participants. 
...
* Ask less questions.
* If you lack a context for a meaningful reply end the dialog.
* Use modern slang.`;
...
const generativeModelOptions: ModelParams = {
  ...
  ${featureFlags.humanize ? 'Adjust the tone of the reply to be a little bit more blunt, and impolite.' : ''} `,
	safetySettings,
};
...
export function loadConfig(): void {
	const requiredEnvVariables = ['BOT_ID', 'API_ID', 'SESSION', 'DB_NAME', 'LANGUAGE', 'API_HASH', 'BOT_USERNAME', 'GAPI', 'SECRET_OPTIONS'];
