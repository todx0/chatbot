...
export const toxicRecapRequest = `There are few recaps of the conversation. Combine them and do a detailed recap in ${language} language in a little of sarcastic way and sound that you are annoyed:`;
