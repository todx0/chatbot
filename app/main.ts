...
const processCommand = async (event: any) => {
	...
	if (message?.originalArgs.mentioned) {
		...
		if (messageResponse) {
			...
			const gptRequest = `This is conversation history: ${currentHistory} \n This is your message: ${messageResponse} \n Here is a person's reply to your message: ${replyTo}. Only reply to person's message in his language in sarcastic tone. Do not include 'User:','You:' and 'Person:' in reply.`;
